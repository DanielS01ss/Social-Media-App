...
useEffect(()=>{
  if(passwordMatch && validEmail && username!='' && emailVal!='' && password!='')
  {
    setValidForm(true);
  } else {
    setValidForm(false);
...
},[username,emailVal,password,repeatPass,passwordMatch,validEmail]);
   ...
   <div className="container-login100" >
     <div className="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
       <form className="login100-form validate-form" method="POST" onSubmit ={handleReq}>
         ...
         <p className="wrong-credentials not-display">Username taken!</p>
       <div className="wrap-input100 validate-input m-b-23" style={{"marginTop":'30px'}} data-validate = "Username is reauired">
         ...
         <br/><span className="wrong-credentials not-display">There is already an account registerd with this email!</span>
